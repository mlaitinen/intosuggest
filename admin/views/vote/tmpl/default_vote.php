...
<form name="adminForm" id="adminForm" action="index.php?option=com_intosuggest&controller=vote" method="POST">
...
<table width="100%" class="adminlist" cellpadding="0" cellspacing="0">	
	...
	<?php
		...
		if (count($votes)){
			...
			$link = "index.php?option=com_intosuggest&controller=vote&task=edit&id=".$vote->id;
	?>
