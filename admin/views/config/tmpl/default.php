...
<form name="adminForm" id="adminForm" action="index.php?option=com_intosuggest&controller=config" method="POST">
                            ...
                            <fieldset>
                                ...
                                <table class="admintable">
                                    <tr>
                                        ...
                                        <td>
                                            <?php $avatar = isset($this->gconfig['avatar']->value) ? $this->gconfig['avatar']->value : 'gravatar'; ?>
