...
window.addEvent("domready", function(){
	...
	$("btn_add_datetime").addEvent("click", function(){
		...
		var url = "index.php?option=com_intosuggest&controller=config&task=addDatetime&value="+value;
	...
	$("btn_remove_datetime").addEvent("click", function(){
		var url = "index.php?option=com_intosuggest&controller=config&task=removeDatetime&id="+$("lst_datetime").value;
		//alert(url);
		var req = new Ajax(url,{
			method:'get',			
			onComplete:function(result){
	...
	$("btn_default_datetime").addEvent("click", function(){
		var url = "index.php?option=com_intosuggest&controller=config&task=setDefaultDatetime&id="+$("lst_datetime").value;
		var req = new Ajax(url,{
			method:'get',			
			onComplete:function(result){
				var list = $("lst_datetime");
	...
	function onDatetimeChange(){
		...
		var url = "index.php?option=com_intosuggest&controller=config&task=getDatetimeInfo&id="+$("lst_datetime").value;
		var req = new Ajax(url,{
			method:'get',			
			onComplete:function(result){
				eval("var obj = "+result);
