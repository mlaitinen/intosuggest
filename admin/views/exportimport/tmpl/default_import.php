...
<table class="adminlist">
	...
	?>
		<tr class="row<?php echo $k; $k = 1-$k;?>">
			...
			<td><a href="index.php?option=com_intosuggest&controller=exportimport&task=editImport&filename=<?php echo $file->name;?>"><b><?php echo $file->name; ?></b></a></td>
			<td align="center"><a href="index.php?option=com_intosuggest&controller=exportimport&task=download&dir=import&filename=<?php echo $file->name;?>&sign=import"><?php echo JHTML::_('image.administrator','download_f2.png',NULL,'/images/download_f2.png',NULL,'Download file','width=25px')?></a></td>
			...
			<td align="center"><a href="index.php?option=com_intosuggest&controller=exportimport&task=deleteImport&filename=<?php echo $file->name;?>&sign=import"><?php echo JHTML::_('image.administrator','delete_f2.png',NULL,'/images/delete_f2.png',NULL,'Delete file','width=25px')?></a></td>
		</tr>
	<?php 
			}
		}
