...
$doc->addStyleSheet(JURI::base() . "components/com_intosuggest/assets/jlord_core.css");
$doc->addScript(JURI::base() . "components/com_intosuggest/assets/jlord_core.js");
...
function sendMail(t){
	var url = "index.php?option=com_intosuggest&controller=upgrade&task=sendMail&format=raw";
...
<div class="col width-40" style="float:left;">
	...
	<div style="padding: 0 10px 10px 10px;">
		...
		<?php
			...
			$jp 	= JComponentHelper::getParams('com_intosuggest');
			$db 	= &JFactory::getDBO();
			$email 	= $jp->get('default_email');
			
			$href='index.php?option=com_config&controller=component&component=com_intosuggest&e[]=quick_ticket_email&e[]=feed_back_email';
			if( !$obIsJ15 ){
				$href='index.php?option=com_config&view=component&component=com_intosuggest&path=&tmpl=component&e[]=quick_ticket_email&e[]=feed_back_email';
			}
		?>
		...
		?>
				<div id="form_feedback" class="jform oblangs">
					<div style="margin:5px;"  class="content">
						...
						<a href="index.php?option=com_config&controller=component&component=com_intosuggest&e[]=quick_ticket_email&e[]=feed_back_email" rel="{handler: 'iframe', size: {x: 700, y: 300}}" class="modal" >
						<?php echo JText::_("CHANGE_DEFAULT_E_MAIL");?>
						</a>	  
						<br />
