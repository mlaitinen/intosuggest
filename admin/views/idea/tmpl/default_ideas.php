...
<form name="adminForm" id="adminForm" action="index.php?option=com_intosuggest&controller=idea" method="POST">
...
?>
	<tr style="height: 10px;" class="<?php echo "row$k"; ?>">
		...
		<td>
			<div style="font-weight: bolder;color: #0B55C4;"><a href="index.php?option=com_intosuggest&controller=idea&task=view&id=<?php echo $idea->id; ?>&forum_id=<?php echo $idea->forum_id; ?>"><?php echo $idea->title; ?></a></div>
			<div style="float: left;"><b><?php echo $this->countComment($idea->id);?></b> <?php echo JText::_("Comment")?></div>
			<div style="float: left; margin-left: 3px;">| <a href="index.php?option=com_intosuggest&controller=idea&task=edit&id=<?php echo $idea->id; ?>&forum_id=<?php echo $idea->forum_id; ?>"><?php echo JText::_("Edit")?></a></div>
			<div style="float: left; margin-left: 3px;">| <a href="index.php?option=com_intosuggest&controller=idea&task=delete&id=<?php echo $idea->id; ?>&forum_id=<?php echo $idea->forum_id; ?>"><?php echo JText::_("Delete")?></a></div>
		</td>
...
<input type="hidden" name="option" value="com_intosuggest" />
