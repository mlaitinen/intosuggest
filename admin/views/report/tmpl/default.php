...
function repair(t, f, e, r, rename)
{
	...
	enableRow(r, false);
	var url = "index.php?option=com_intosuggest&controller=report";
...
<form name="adminForm" id="adminForm" action="index.php?option=com_intosuggest&controller=report" method="POST">
<?php 
