	...
	?>
		<tr id="row_<?php echo $index?>" class="<?php echo ($error==_FS_TABLE_NOT_EXISTS||$error==_FS_COLUMN_NOT_EXISTS||$error==_FS_DIR_NOT_EXISTS ||$error==_FS_COLUMN_EXCESS)?"error":"warning"?>">
			...
			<td <?php echo $rowspan?> align="right" valign="middle" style="border-right:0px solid red;">
				...
				{
				?>
				<img src="<?php echo "components/com_intosuggest/assets/images/icons/error_icon.png"?>" width="16" height="16">
				</td>
				<td <?php echo $rowspan?>>
				Error
				<?php 
				...
				{
				?>
				<img src="<?php echo "components/com_intosuggest/assets/images/icons/warning_icon.jpg"?>" width="16" height="16">
				</td>
				<td <?php echo $rowspan?>>
				Warning
				<?php 
