...
<form name="adminForm" id="adminForm" action="index.php?option=com_intosuggest&controller=forum" method="POST">
...
<table width="100%" class="adminlist" cellpadding="0" cellspacing="0">
	...
	?>
		<tr class="row<?php echo $k;?>">	
			...
			<td>
				<div style="font-weight: bolder;"><a href="index.php?option=com_intosuggest&controller=forum&task=view&id=<?php echo $forum->id; ?>"><?php echo $forum->name; ?></a></div>
				...
				<div style="float: left; padding-right: 3px"><a href="index.php?option=com_intosuggest&controller=forum&task=edit&id=<?php echo $forum->id; ?>"><?php echo JText::_("Edit")?></a></div>
				<div style="float: left; padding-right: 3px">|</div>
				<div style="float: left; padding-right: 3px">
					<?if($forum->default == 0){?>
					<a href="index.php?option=com_intosuggest&controller=forum&task=delete&id=<?php echo $forum->id; ?>"><?php echo JText::_("Delete")?></a>
					<?}else{?>
						<?php echo JText::_("Delete")?>
					<?}?>
				</div>					
				<div style="float: left; padding-right: 3px">|</div>
				<div style="float: left; padding-right: 3px"><a href="index.php?option=com_intosuggest&controller=forum&task=import&id=<?php echo $forum->id; ?>"><?php echo JText::_("Import")?></a></div>
			</td>
			<td align="center">
