...
class ModelVote extends JModel {
	...
	public function getListVotes(){
		...
		$query = "SELECT * FROM #__intosuggest_votes_value ".$where;
	...
	public function save($input){
		global $mainframe;
		if ($input['tmp'] == 'add'){
			$query = "INSERT INTO #__intosuggest_votes_value(`vote_value`,`title`,`published`)".
					"VALUES (".
						$input['vote_value'].",'".
			...
			$query = "UPDATE #__intosuggest_votes_value".
	...
	public function getConfigLimit() {
		...
		$option= JRequest::getVar('option',"com_intosuggest");
	...
	public function addStatus($_input) {
		$query = "
			INSERT INTO #__intosuggest_status(`title`,`parent_id`)
			VALUES (
				'".$_input['title']."',
				".$_input['parent_id']."
			);";
	...
	public function deleteStatus($_input) {
		$query = "
			DELETE FROM `#__intosuggest_status`			
			WHERE `id` = ".$_input['id']."
		;";					
		DBase::querySql($query);
	}
	...
	public function editVotes(){
		$query  = "SELECT * FROM #__intosuggest_votes_value".
	...
	public function addConfig($_input = null) {
		...
		$query = "
			INSERT INTO #__intosuggest_idea(`title`,`content`,`resource`,`user_id`,`forum_id`,`createdate`,`status_id`,`published`,`votes`)
