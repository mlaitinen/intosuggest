...
class ModelForum extends JModel {
	...
	public function addForum($_input) {
		...
		$query = " 			
			INSERT INTO `#__intosuggest_forum`($key)
			VALUES ($value)
		;";		
		DBase::querySQL($query);
...
//		$this->setState('limitstart', $limitstart);	
		...
		$query = "
			SELECT p.* 
			FROM `#__intosuggest_forum` as p $orderby
		";
