...
class ModelReport extends JModel 
{
	...
	/**
	 * get alls tables use for this component (must contains 'intosuggest')
	 *
	 * @return unknown
	 */
	public function getTablesOfComponent($filter = '')
	{
		...
		$prefix 	= $conf->getValue('config.dbprefix');
 		...
 		if($filter == '')
 			$query = "SHOW TABLES LIKE '%intosuggest%'";
 		else 
	...
	public function createTableStore()
	{
		...
		$query = "
			CREATE TABLE IF NOT EXISTS #__intosuggest_error
			(
	...
	function createDefaultData($path)
	{
		...
		<database>
			<tables>
				<table>
					<name>#__intosuggest_account</name>
					<fields>
				...
				<table>
					<name>#__intosuggest_comment</name>
					<fields>
						<field type="int(11)" null="NO" key="PRI" default="" extra="auto_increment">id</field>
				...
				<table>
					<name>#__intosuggest_config</name>
					<fields>
						<field type="int(11)" null="NO" key="PRI" default="" extra="auto_increment">id</field>
				...
				<table>
					<name>#__intosuggest_forum_article</name>
					<fields>
				...
				<table>
					<name>#__intosuggest_permission</name>
					<fields>
				...
				<table>
					<name>#__intosuggest_status</name>
					<fields>
						<field type="int(11)" null="NO" key="PRI" default="" extra="auto_increment">id</field>
				...
				<table>
					<name>#__intosuggest_votes_value</name>
					<fields>
