<?php
/**
 * @version		$Id: intosuggest.php 301 2011-04-04 09:02:09Z phonglq $
...
require_once JPATH_SITE.'/components/com_intosuggest/helper/router.php';

/**
 * IntoSuggest Search plugin
 *
 * @package		Joomla
 * @subpackage	Search
 * @since		1.6
...
class plgSearchObSuggest extends JPlugin
{
	...
	{
		static $areas = array(
			'intosuggest' => 'PLG_SEARCH_INTOSUGGEST_IDEAS');
			return $areas;
	}
	...
	function onContentSearch($text, $phrase='', $ordering='', $areas=null)
	{
		...
		#require_once JPATH_SITE.'/components/com_intosuggest/helpers/route.php';
		...
		$query = 'SELECT j.`id`,
					...
					j.`published`, 
					"2" AS `browsernav`
				FROM #__intosuggest_idea j, #__intosuggest_forum jf
		...
		if (isset($list))
		{
			...
			{
				$list[$key]->href  = JRoute::_(intosuggestsHelperRouter::addItemId('index.php?option=com_intosuggest&controller=comment&idea_id='.$item->id));
			}
		}
		$rows[] = $list;
