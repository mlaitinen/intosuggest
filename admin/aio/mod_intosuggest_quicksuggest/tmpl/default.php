...
function addSuggestion() {
	...
	var url = "index.php?option=com_intosuggest&controller=idea&task=addIdea&forum_id="+id+"&title="+title+"&content="+fulltext;
...
<div class="<?php echo $params->get('moduleclass_sfx'); ?>">
    ...
    <div id="quick_suggestion_button">
		...
		<div style="float: right; line-height: 30px;"><a href="index.php?option=com_intosuggest&Itemid=70" class="hasTip" title="Suggestions::View All Suggested Ideas">Suggested Ideas</a></div>
    </div>
