...
class ControllerVote extends JController {
	...
	public function published() {
		global $mainframe;
			...
			$mainframe->redirect( 'index.php?option=com_intosuggest&controller=vote','Published:'.count($cid) );
	}
	...
	public function remove(){
		global $mainframe;
			...
			$query = 'DELETE FROM `#__intosuggest_votes_value`'
			. ' WHERE `id` IN ( '. $cids .' )';
			$db->setQuery( $query );
			$db->query();
			$mainframe->redirect( 'index.php?option=com_intosuggest&controller=vote','Delete:'.count($cid) );
	}
