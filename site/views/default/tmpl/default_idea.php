			...
			<table>
				...
				<tr>
					...
					<td id="rps<?php echo $this->idea->id; ?>">
						<div onclick="addRepose('rps<?php echo $this->idea->id; ?>')" onmousemove="onmove('rps<?php echo $this->idea->id; ?>')" onmouseout="onout('rps<?php echo $this->idea->id; ?>')"><i><?php echo JText::_("ADD_RESPONSE")?></i></div>
					</td>
					<?php } else { ?>
					<td>
