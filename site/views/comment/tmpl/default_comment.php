...
<div class="<?php echo $class; ?>" id="comment_<?php echo $comment->id;?>">
	...
	<div class="comment_desc_info">
		<span class="createdate">
			<div>
				...
				<?php }?>
				<?php echo JText::_("CREATED_ON"); ?> <?php echo JHTML::_('date', strtotime($comment->createdate), JText::_('DATE_FORMAT_LC2')); ?></div>							
	...
	<!-- Change Status -->
			<div class="active" id ="edt<?php echo $comment->id; ?>">
					<a id="edit_modal_<?php echo $comment->id; ?>" class="edit_modal" href="index.php?option=com_intosuggest&controller=comment&task=editComment&id=<?php echo $comment->id;?>&format=raw" rel="{handler: 'iframe',size: {x: 430, y: 280}}"> <?php echo JText::_("Edit")?></a>&nbsp;|&nbsp; 
			</div>
	<!-- Change Status -->
			<?php }?>
		</span>
