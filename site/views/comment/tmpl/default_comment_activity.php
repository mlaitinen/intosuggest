...
<div style="padding-right:10px;">
	<span class="createdate">
		...
		<div class="active" id ="edt<?php echo $comment->id;?>" style="float:right;" onClick="onedit(<?php echo $comment->id;?>)" >
			...
			<a id="frm_Edit_<?php echo $comment->id;?>" href="index.php?option=com_intosuggest&controller=comment&task=editComment&id=<?php echo $comment->id;?>&format=raw" rel="{handler: 'iframe',size: {x: 430, y: 280}}"></a>
		</div>
		<?php }?>
	</span>
</div></div>
