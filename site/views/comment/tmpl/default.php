...
JHTML::_('behavior.modal');
	...
	//$document->addStyleSheet( JURI::base() ."components/$option/assets/css/intosuggest.css" );
...
<form name="adminForm" action="index.php?option=com_intosuggest&controller=comment" method="POST">
<?php
