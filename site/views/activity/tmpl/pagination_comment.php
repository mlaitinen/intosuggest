				...
				<td align="right">
					<span class="createdate">
						...
						<div class="active" id ="edt<?php echo $comment->id;?>" style="float:right;" onClick="onedit(<?php echo $comment->id;?>)" >
								...
								<a id="frm_Edit_<?php echo $comment->id;?>" href="index.php?option=com_intosuggest&controller=comment&task=editComment&id=<?php echo $comment->id;?>&format=raw" rel="{handler: 'iframe',size: {x: 418, y: 275}}"></a>
						</div>
						<?php }?>
					</span>					
					<!-- <a class="modal"  rel="{handler: 'iframe',size: {x: 418, y: 275}}" href="index.php?option=com_intosuggest&controller=comment&task=editComment&id=<?php echo $comment->id;?>&format=raw">Edit</a>-->
				</td>
			</tr>	
			<tr>
				<td>
