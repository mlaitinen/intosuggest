...
#END lay cac ideas
	...
	function changePage() {
		global $mainframe;		
		//$mainframe->redirect("index.php?option=com_intosuggest&forumId=".$_POST['forumId']);
		$mainframe->redirect(JRoute::_("index.php?option=com_intosuggest&forumId=".JRequest::getVar('forumId')));
	}
