...
function addRepose(id) {
	...
	txt +="<br />";
	txt += "<input type='button' onclick=\"addResponse('"+id+"')\" value='" + getSaveText() + "'/>";
	txt += "<input type='button' style=\"margin:0px 2px;\" onclick=\"refesh('"+num_id+"','"+oldValue+"')\" value='" + getCancelText() + "'/>";
