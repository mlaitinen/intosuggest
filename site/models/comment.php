...
class ModelComment extends JModel {
	...
	public function getCountCommentsWithUser($comment_id)
	{
		...
		$query = "
			SELECT i.id as id FROM #__intosuggest_idea, #__intosuggest_comment c
	...
	public function delComment() {
		$query = "DELETE FROM `#__intosuggest_comment` WHERE `id` =".$this->comment_id;
	...
	public function editComment() {
		$query = "SELECT * FROM `#__intosuggest_comment` WHERE `id` = ".$this->comment_id;
		return DBase::getObjectList($query);
	}

	public function updateComment($input) {
		$input['comment_content'] = Config::fixBadWord($input['comment_content']);
		$query = "UPDATE `#__intosuggest_comment` ".
	...
	public function getForumId(){
		$query = "SELECT `forum_id` FROM #__intosuggest_idea WHERE `id` = ".$this->idea_id;
		return  DBase::getObjectResult($query);
	}

	public function getForumInfo() {
		$query = "SELECT uf.* FROM #__intosuggest_forum uf inner join `#__intosuggest_idea` ui ON ui.`forum_id` = uf.`id`
	...
	public function addComment($_input) {
		...
		$query = "
			INSERT INTO #__intosuggest_comment(`idea_id`,`forum_id`,`comment`,`createdate`,`user_id`)				
			VALUES (".
				$_input['idea_id'].",".
				$_input['forum_id'].",\"".
